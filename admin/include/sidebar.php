...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
								<li><a href="staff-logs-edit.php"><i class="menu-icon icon-tasks"></i>Staff Title Edit Logs</a></li>
							<li><a href="staff-logs.php"><i class="menu-icon icon-tasks"></i>Staff Login Logs </a></li>
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Users Login Logs </a></li>
								<li>
								<a href="manage-users.php">
									<i class="menu-icon icon-group"></i>
									Manage Staff
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="state.php"><i class="menu-icon icon-paste"></i>Add Regions</a></li>
							<li>
								<a href="logout.php">
