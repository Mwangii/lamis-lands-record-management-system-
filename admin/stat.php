...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select stateName from state where stateName='$state'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$_SESSION['msg']="Records already exists !!";
    }
    else{
...
<label class="control-label" for="basicinput">Region Name</label>
<div class="controls">
