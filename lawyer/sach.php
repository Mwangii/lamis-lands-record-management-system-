...
<html lang="en">
  <head>
    ...
    <title>LAMIS |  Land/Property Search</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Land/Property Search</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>Quick Search</h4>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="password" name="password"   placeholder="Enter Title Number /Property Number/LR Number" required="required" class="form-control">
                              </div>
                          </div>
