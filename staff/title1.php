...
<div class="controls">
<input type="text" placeholder="Enter State Name"  name="titleNo" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="area" rows="5"></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">MAP SHEET NO.</label>
											<div class="controls">
												<textarea class="span8" name="map" rows="5"></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">COORDINATES</label>
											<div class="controls">
												<textarea class="span8" name="coord" rows="5"></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">OWNERS NAME</label>
											<div class="controls">
												<textarea class="span8" name="name" rows="5"></textarea>
											</div>
										</div>
										<div class="control-group">
											<label class="col-sm-2 col-sm-2 control-label">Title Deed Scanned Original 	Copy (if any) </label>
											<div class="controls">
